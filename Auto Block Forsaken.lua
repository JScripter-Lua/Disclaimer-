...
local ConfigManager = Compkiller:ConfigManager({
    Directory = "AutoBlockHub",
    Config = "Settings"
});

-- Loading UI
Compkiller:Loader("rbxassetid://4483362458", 2).yield();
...
local Main = Color3.fromRGB(150, 50, 255)
...
Compkiller.Colors.HighStrokeColor  = Color3.fromRGB(90, 110, 140)
...
Notifier.new({
    Title = "Aorora Hex (Forsaken V1.5)",
    Content = "Aurors Hex is loaded successfully",
    Duration = 5,
...
-- Creating Tabs
local AutoBlockTab = Window:DrawTab({
    Name = "Auto Block",
    Icon = "shield",
    Type = "Double"
});

local BDTab = Window:DrawTab({
    Name = "Better Detection",
    Icon = "radar",
    Type = "Double"
});

local PredictiveTab = Window:DrawTab({
    Name = "Predictive Auto Block",
    Icon = "cpu",
    Type = "Single"
});

local FakeBlockTab = Window:DrawTab({
    Name = "Fake Block",
    Icon = "layers",
    Type = "Single"
});

local AutoPunchTab = Window:DrawTab({
    Name = "Auto Punch",
    Icon = "zap",
    Type = "Double"
});

local CustomAnimationsTab = Window:DrawTab({
...
-- Auto Block Tab Sections
local AutoBlockSection = AutoBlockTab:DrawSection({
    Name = "Auto Block Settings",
    Position = 'left'
});

local AutoBlockSection2 = AutoBlockTab:DrawSection({
    Name = "Detection Settings",
    Position = 'right'
});

-- BD Tab Sections
local BDSection = BDTab:DrawSection({
    Name = "Better Detection",
    Position = 'left'
});

local BDSection2 = BDTab:DrawSection({
    Name = "Advanced Settings",
    Position = 'right'
});

-- Other Tab Sections
local PredictiveSection = PredictiveTab:DrawSection({
    Name = "Predictive Settings",
    Position = 'left'
});

local FakeBlockSection = FakeBlockTab:DrawSection({
    Name = "Fake Block",
    Position = 'left'
});

local AutoPunchSection = AutoPunchTab:DrawSection({
    Name = "Auto Punch Settings",
    Position = 'left'
});

local AutoPunchSection2 = AutoPunchTab:DrawSection({
    Name = "Fling Settings",
    Position = 'right'
});

local CustomAnimSection = CustomAnimationsTab:DrawSection({
    Name = "Block & Punch Animations",
    Position = 'left'
});

local CustomAnimSection2 = CustomAnimationsTab:DrawSection({
...
AutoBlockSection2:AddDropdown({
    Name = "Facing Check Mode",
    Options = {"Loose", "Strict"},
    Default = looseFacing and "Loose" or "Strict",
