...
local Tabs = {
    Combat = Window:CreateTab("ออร่าห์"),
    Main   = Window:CreateTab("หน้าหลัก"),
    Auto   = Window:CreateTab("ออโต้"),
    ESP    = Window:CreateTab("โปรมอง"),
    Bring  = Window:CreateTab("โปรเอาของ"),
    Tp     = Window:CreateTab("วาร์ปไปที่"),
    Player = Window:CreateTab("โปรเดินและกระโดด")
}

------------------------------------------------------------------
-- 7.  COMBAT TAB
------------------------------------------------------------------
Tabs.Combat:CreateSection("ออร่าห์")
Tabs.Combat:CreateToggle({Name = "ออร่าห์ ฆ่า", CurrentValue = false, Flag = "KillAura", Callback = function(v)
    killAuraToggle = v
    if v then task.spawn(killAuraLoop) else local tool, _ = getAnyToolWithDamageID(false); unequipTool(tool) end
end})
Tabs.Combat:CreateToggle({Name = "ออร่าห์ตัดไม้", CurrentValue = false, Flag = "ChopAura", Callback = function(v)
    chopAuraToggle = v
    if v then task.spawn(chopAuraLoop) else local tool, _ = getAnyToolWithDamageID(true); unequipTool(tool) end
end})
Tabs.Combat:CreateSlider({Name = "ระยะออร่าห์", Range = {10, 500}, Increment = 10, Suffix = " studs", CurrentValue = 50, Flag = "AuraRadius", Callback = function(v) auraRadius = v end})

------------------------------------------------------------------
-- 8.  MAIN TAB
------------------------------------------------------------------
Tabs.Main:CreateSection("ออโต้กิน")
...
-- 9.  AUTO TAB
------------------------------------------------------------------
Tabs.Auto:CreateSection("ออโต้ อัปเกรด แคมไฟ")
...
Tabs.Auto:CreateToggle({Name = "ออโต้ อัปเกรด แคมไฟ", CurrentValue = false, Flag = "AutoUpgrade", Callback = function(v)
...
Tabs.Auto:CreateSection("ออโต้ ปิ้งอาหาร")
...
Tabs.Auto:CreateToggle({Name = "ออโต้ ปิ้งอาหาร", CurrentValue = false, Flag = "AutoCook", Callback = function(v) autoCookEnabled = v end})
...
Tabs.ESP:CreateSection("โปรมองหาของ")
Tabs.ESP:CreateDropdown({Name = "โปรมองหาของ", Options = ie, CurrentOption = {}, MultipleOptions = true, Flag = "ESPI", Callback = function(opts)
    selectedItems = opts
...
Tabs.ESP:CreateToggle({Name = "เปิด โปรมองหาของ", CurrentValue = false, Flag = "EnableESPI", Callback = function(v)
    espItemsEnabled = v
    for _, name in ipairs(ie) do
...
Tabs.ESP:CreateSection("โปรมองหาสิ่งมีชีวิต")
Tabs.ESP:CreateDropdown({Name = "เลือกสิ่งมีชีวิต", Options = me, CurrentOption = {}, MultipleOptions = true, Flag = "ESPM", Callback = function(opts)
    selectedMobs = opts
...
Tabs.ESP:CreateToggle({Name = "เปิดโปร มองหาสิ่งมีชีวิต", CurrentValue = false, Flag = "EnableESPM", Callback = function(v)
    espMobsEnabled = v
    for _, name in ipairs(me) do
...
Tabs.Bring:CreateDropdown({Name = "เลือกขยะ", Options = junkItems, CurrentOption = {}, MultipleOptions = true, Flag = "JunkList", Callback = function(v) selectedJunkItems = v end})
Tabs.Bring:CreateButton({Name = "เก็บขยะที่เลือก", Callback = function() bringItems(selectedJunkItems) end})

Tabs.Bring:CreateSection("Fuel")
Tabs.Bring:CreateDropdown({Name = "เลือกเชื้อเพลิง", Options = fuelItems, CurrentOption = {}, MultipleOptions = true, Flag = "FuelList", Callback = function(v) selectedFuelItems = v end})
Tabs.Bring:CreateButton({Name = "เก็บเชื้อเพลิงทีีเลือก", Callback = function() bringItems(selectedFuelItems) end})

Tabs.Bring:CreateSection("Food")
Tabs.Bring:CreateDropdown({Name = "เลือกอาหาร", Options = foodItems, CurrentOption = {}, MultipleOptions = true, Flag = "FoodList", Callback = function(v) selectedFoodItems = v end})
Tabs.Bring:CreateButton({Name = "เก็บอาหารที่เลือก", Callback = function() bringItems(selectedFoodItems) end})

Tabs.Bring:CreateSection("Medicine")
Tabs.Bring:CreateDropdown({Name = "เลือกยา", Options = medicalItems, CurrentOption = {}, MultipleOptions = true, Flag = "MedList", Callback = function(v) selectedMedicalItems = v end})
Tabs.Bring:CreateButton({Name = "เก็บยาที่เลือก", Callback = function() bringItems(selectedMedicalItems) end})

Tabs.Bring:CreateSection("Equipment")
Tabs.Bring:CreateDropdown({Name = "เลือกอุปกรณ์", Options = equipmentItems, CurrentOption = {}, MultipleOptions = true, Flag = "EquipList", Callback = function(v) selectedEquipmentItems = v end})
Tabs.Bring:CreateButton({Name = "เก็บอุปกรณ์ที่เลือก", Callback = function() bringItems(selectedEquipmentItems) end})

------------------------------------------------------------------
-- 12.  TELEPORT TAB
------------------------------------------------------------------
Tabs.Tp:CreateButton({Name = "วาร์ปไปที่ แคมไฟ", Callback = tp1})
Tabs.Tp:CreateButton({Name = "วาร์ปไปที่ รังพวกลัทธิ", Callback = tp2})
...
Tabs.Player:CreateSlider({Name = "เลือกความเร็ว", Range = {16, 150}, Increment = 1, Suffix = "", CurrentValue = 16, Flag = "WalkSpeed", Callback = function(v) speed = v end})
Tabs.Player:CreateToggle({Name = "เปิดโปร วิ่งไว", CurrentValue = false, Flag = "EnableSpeed", Callback = function(v)
    local humanoid = LocalPlayer.Character and LocalPlayer.Character:FindFirstChildOfClass("Humanoid")
    if humanoid then humanoid.WalkSpeed = v and speed or 16 end
end})

local noclipConnection
Tabs.Player:CreateToggle({Name = "โปรทะลุกำแพง", CurrentValue = false, Flag = "Noclip", Callback = function(v)
    if v then
...
Tabs.Player:CreateToggle({Name = "เดินชมจันทร์", CurrentValue = false, Flag = "InfJump", Callback = function(v)
    if v then
...
------------------------------------------------------------------
Tabs.Main:CreateSection("อื่นๆไงไอ้ควาย")
Tabs.Main:CreateToggle({Name = "ตอบโต้ทันที", CurrentValue = false, Flag = "InstantInteract", Callback = function(v)
...
Tabs.Main:CreateToggle({Name = "ออโต้ สตั้น กวาง", CurrentValue = false, Flag = "AutoStunDeer", Callback = function(v)
    if v then
